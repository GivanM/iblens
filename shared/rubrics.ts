...
const ECONOMICS_IA: Rubric = {
  ...
  notes: "Word limit 800 per commentary, moderators will not read beyond 800 words. The full portfolio is marked out of 45: three commentaries (14 each) + Criterion F: Rubric requirements (3): different units, different sources, articles no older than one year. Each commentary must use a different key concept. Diagrams do not come through pasted text: mark Criterion A on the diagrams the commentary identifies and explains, do not lower it because a diagram or its labels cannot be seen, and say in the comment that the diagrams were not seen and that levels 2 and 3 also need them to be accurate and correctly labelled, so the mark assumes they are.",
