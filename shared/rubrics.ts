...
const MUSIC_IA: Rubric = {
  ...
  notes: "This is Exploring music in context, externally assessed coursework, not the Music internal assessment (Experimenting with music). Portfolio maximum 2,400 words. C1 and C2 judge the creating exercise and the performed adaptation themselves, which are submitted as separate score and audio files and are not in the pasted text (the written implications for those exercises are assessed under B2). Return C1 and C2 with \"score\": null and a comment saying they were not assessed because the exercises are not part of the paste; \"max_score\" is the sum of the criteria you did assess and \"band_range\" is expressed on that total. Do not treat the missing exercises as a weakness.",
