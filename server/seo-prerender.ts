...
const routeMeta: Record<string, PageMeta> = {
  ...
  "/essay": {
    ...
    faq: [
      ...
      { question: "Is the first analysis really free?", answer: "Yes — your first analysis is free: your band range, your weakest criterion with full examiner-style feedback, and the top risks in your draft. The complete report — exact score, every criterion with comments, and a ranked fix list — unlocks for $4.99." },
  ...
  "/pricing": {
    ...
    schemaType: "WebPage",
    faq: [
      { question: "How much does IBLens cost?", answer: "Your first analysis is free. The full report costs $4.99, a pack of 5 is $19.99, and a pack of 10 is $34.99. There is no subscription \u2014 you pay only for what you use." },
