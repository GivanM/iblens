...
const routeMeta: Record<string, PageMeta> = {
  ...
  "/essay/biology-ia": {
    ...
    description: "AI feedback in about 90 seconds on your IB Biology Internal Assessment. Research design, data analysis, conclusion and evaluation scored against the official IB criteria. Free.",
    ogType: "website",
  ...
  "/essay/chemistry-ia": {
    ...
    description: "Get AI feedback on your IB Chemistry Internal Assessment. All four criteria scored against the official IB Chemistry rubric. First analysis free.",
    ogType: "website",
  ...
  "/essay/physics-ia": {
    ...
    description: "AI-powered feedback on your IB Physics Internal Assessment. All four criteria: research design, data analysis, conclusion, evaluation. Free.",
    ogType: "website",
  ...
  "/essay/math-ia": {
    ...
    description: "Get AI feedback in about 90 seconds on your IB Mathematics IA exploration. Presentation, mathematical communication, personal engagement, reflection and use of mathematics \u2014 all scored against official IB Math criteria.",
    ogType: "website",
  ...
  "/essay/psychology-ia": {
    ...
    description: "AI feedback on your IB Psychology Internal Assessment. Introduction, exploration, analysis and evaluation scored against the official IB Psychology criteria.",
    ogType: "website",
  ...
  "/essay/maths-aa-ia": {
    ...
    description: "AI feedback on your IB Mathematics: Analysis and Approaches IA. Presentation, mathematical communication, personal engagement, reflection and use of mathematics — all scored against the official IB criteria.",
    ogType: "website",
