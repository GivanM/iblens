export const staticContentResources: Record<string, string> = {
  ...
  <nav style="font-size:13px;color:#6b7280;margin-bottom:20px"><a href="/">Home</a> › <a href="/resources">Resources</a> › Sample Reports</nav>
      ...
      <p><a href="/essay">Get this exact report for your own essay — free preview, full report $4.99 →</a></p>
    </main>`,
  ...
  <h2 style="font-size:22px;font-weight:700;margin:24px 0 10px">How to check your draft against the new criteria</h2>
  <ul style="line-height:1.8;padding-left:20px;margin:0 0 14px">
  ...
  <tr><td style="border:1px solid #ddd;padding:8px">Good</td><td style="border:1px solid #ddd;padding:8px">7–8</td><td style="border:1px solid #ddd;padding:8px">Focused on the title with real analysis and some evaluation of perspectives</td></tr>
  <tr><td style="border:1px solid #ddd;padding:8px">Satisfactory</td><td style="border:1px solid #ddd;padding:8px">5–6</td><td style="border:1px solid #ddd;padding:8px">Relevant but more descriptive than critical</td></tr>
  <tr><td style="border:1px solid #ddd;padding:8px">Basic</td><td style="border:1px solid #ddd;padding:8px">3–4</td><td style="border:1px solid #ddd;padding:8px">Loses the title; assertions instead of arguments</td></tr>
  <tr><td style="border:1px solid #ddd;padding:8px">Rudimentary</td><td style="border:1px solid #ddd;padding:8px">1–2</td><td style="border:1px solid #ddd;padding:8px">Little connection to the title</td></tr></table>
  ...
  <p style="line-height:1.7;margin:0 0 14px">Run this checklist before your teacher's feedback round so it is spent on substance. For an instant second opinion, IBLens applies the holistic instrument to your draft and shows the band range it currently sits in — free, before any payment.</p>
  ...
  <p style="line-height:1.7;margin:0 0 14px">EE feedback is rationed: your supervisor may give written comments on one complete draft, teachers cannot edit your work, and peers do not know the criteria. The channels compared honestly:</p>
  <table style="border-collapse:collapse;width:100%;margin:0 0 14px"><tr><th style="border:1px solid #ddd;padding:8px;text-align:left">Channel</th><th style="border:1px solid #ddd;padding:8px;text-align:left">What it gives you</th><th style="border:1px solid #ddd;padding:8px;text-align:left">The limits</th></tr>
  <tr><td style="border:1px solid #ddd;padding:8px">Supervisor</td><td style="border:1px solid #ddd;padding:8px">Expert, subject-aware comments</td><td style="border:1px solid #ddd;padding:8px">One complete draft; no editing</td></tr>
  <tr><td style="border:1px solid #ddd;padding:8px">Reflection sessions</td><td style="border:1px solid #ddd;padding:8px">Three formal check-ins on direction</td><td style="border:1px solid #ddd;padding:8px">Process guidance, not line-by-line</td></tr>
  ...
  <p style="line-height:1.7;margin:0 0 14px">IBLens applies the holistic instrument to your commentary: band range and weakest area free, full report $4.99. <a href="/essay/tok-exhibition">Check your exhibition commentary</a> · <a href="/resources/tok-essay-checklist">TOK Essay Checklist</a></p>
  ...
  <p style="line-height:1.7;margin:0 0 14px">IBLens grades IA drafts for 17 subjects against the official criteria for your session: band range and weakest criterion free, full report $4.99, no subscription. <a href="/resources/ib-ia-grader">How the IA grader works</a> · <a href="/essay">Check your draft</a></p>
  ...
  <p style="line-height:1.7;margin:0 0 14px"><strong>In short: the Extended Essay is a 4,000-word independent research essay. Through November 2026 it is marked out of 34 (Focus and method 6, Knowledge and understanding 6, Critical thinking 12, Presentation 4, Engagement 6); from the May 2027 session it is marked out of 30 under new criteria. Together with TOK it contributes up to 3 bonus points to your Diploma.</strong></p>
