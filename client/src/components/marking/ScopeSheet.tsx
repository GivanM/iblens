 ...
 */
const DOES = [
  "Marks against the published criteria for the Extended Essay, the TOK essay, the TOK exhibition and the Internal Assessment in 14 subjects.",
        ...
        <div className="ms-no">
          ...
          <ul>
            ...
            <li>
              <em aria-hidden="true">✗</em>
              <span>
                Replace your supervisor. The IB permits written supervisor comments on one draft and no more, so that
                draft is worth arriving at in good shape. You still have to account for every choice in your own words
                at the viva voce, and your school may require you to declare that you used an AI tool.{" "}
