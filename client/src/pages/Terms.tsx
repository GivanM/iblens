    ...
    <div className="py-16 bg-background">
      ...
      <div className="container max-w-3xl">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-6 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-8 [&_h2]:mb-3 [&_p]:text-muted-foreground [&_p]:leading-relaxed [&_li]:text-muted-foreground [&_ul]:list-disc [&_ul]:list-inside [&_ul]:space-y-1.5">
          ...
          <p>Full reports are paid for one at a time or in packs of 5 or 10. Prices are shown in US dollars at checkout, payment is handled by LemonSqueezy, and refunds are covered by our <Link href="/refund-policy" className="text-primary hover:underline">Refund Policy</Link>. A paid report includes two free re-checks: a revised version of the same piece of work, for the same task and subject, submitted within 14 days of the report opening. A different piece of work needs its own report. You are responsible for keeping your account secure.</p>
