...
export default function ComputerScienceIA2027() {
  return (
    ...
    >
      ...
      <p>
        With your teacher's agreement, you can check it with IBLens, which supports both Computer Science rubrics: choose <em>Internal Assessment (IA) or coursework</em> and then <em>Computer Science</em> in the grader, and keep "Exam session" on <em>Exams in May 2027 or later</em>, the default, for the 30-mark criteria above, or switch it to <em>Exams in November 2026, or work submitted in May 2026</em> for the 34-mark rubric. One free preview per device or account; a full report is $9.99 with no subscription and includes two free re-checks of revised versions of the same work within 14 days of the report opening, so you can revise and check whether the fix landed.
      </p>
