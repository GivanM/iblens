...
const resources = [
  ...
  },
  {
    ...
    description: "One exploration annotated passage by passage against criteria A to E, topic ideas for AA and AI, a workable structure, and the mistakes that cost marks.",
    icon: BarChart3,
    readTime: "8 min read",
  },
  {
    ...
    description: "One investigation annotated passage by passage against the criteria, topic ideas, topics to handle carefully, and how to write a real evaluation.",
    icon: BookOpen,
    readTime: "7 min read",
  },
  {
    ...
    description: "One titration investigation annotated passage by passage against the criteria, investigation types that work, and where marks are most often lost.",
    icon: BookOpen,
    readTime: "7 min read",
  },
  {
    ...
    description: "One investigation annotated passage by passage against the criteria, topic ideas, linearising data, and uncertainty analysis.",
    icon: BarChart3,
    readTime: "7 min read",
  },
  {
