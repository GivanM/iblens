    ...
    >
      ...
      <ul>
        <li>
          ...
          to reveal what Stevens cannot admit to himself?
          <em> Why it works:</em> one text, one technique, and an interpretive claim
          that must be argued from close reading of specific passages.
        </li>
        <li>
          To what extent does the epistolary structure of Mary Shelley's
          Frankenstein direct the reader's sympathy between Victor and the creature?
          <em> Why it works:</em> it targets form rather than theme, and "to what
          extent" builds evaluation into the answer.
        </li>
        <li>
          How does Tennessee Williams use stage directions in A Streetcar Named
          Desire to dramatise the gap between Blanche's illusions and her
          circumstances?
          <em> Why it works:</em> it focuses on a concrete, often-ignored formal
          feature and ties it to a specific interpretive problem.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Why is George Orwell's 1984 still relevant today?
          <em> Why it fails:</em> this is not a literary question. It invites social
          commentary and personal opinion instead of analysis of Orwell's choices,
          so almost nothing in the answer can be evidenced from the text.
        </li>
      </ul>
