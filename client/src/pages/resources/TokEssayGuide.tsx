...
export default function TokEssayGuide() {
  return (
    ...
    >
      ...
      <p>
        The TOK course organises knowledge into five <strong>areas of knowledge (AOKs)</strong>, broad disciplines that produce knowledge with characteristic methods:
      </p>
      ...
      <p>
        Ethics is not an area of knowledge. Since 2022 it is one of the four elements of the knowledge framework (scope, perspectives, methods and tools, and ethics) applied within every area of knowledge.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Consider what follows if the argument holds: the top level of the instrument asks for the implications of arguments to be considered</td>
            <td>Stop at the argument without asking what follows from it</td>
          </tr>
        </tbody>
      </table>
      ...
      <ul>
        ...
        <li><strong>Generic examples:</strong> Using "2+2=4" as the only example of mathematical knowledge, or a single famous event as the only example of historical knowledge. Examiners see these constantly</li>
