...
export default function TokExhibitionChecklist() {
  return (
    ...
    >
      ...
      <ul>
        <li>For each object you <em>justify its inclusion</em>: why this object, for this prompt, not just what the object is.</li>
        <li>Claims about what the object shows are supported by evidence about the object and its context.</li>
      ...
      <p>
        <Link href="/essay/tok-exhibition">Check your TOK exhibition commentary →</Link>
      </p>
      ...
      <p>
        No. The exhibition responds to one IA prompt, and all three objects must connect to that same prompt. Clear, explicit links to the selected prompt are exactly what the top band descriptors reward.
      </p>
