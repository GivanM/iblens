    ...
    >
      ...
      <p>
        ...
        rows={[
          ...
          { criterion: "Data analysis", typical: "Raw data is tabulated and a mean is plotted; uncertainties appear once and are then forgotten.", top: "Uncertainties are considered appropriately in the recording and processing, and the processing chosen is the one that answers the research question." },
