  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>IB English A (Literature, or Language and Literature):</strong> the individual oral, marked on four criteria of 10 marks each; paste your outline, or a transcript of a practice oral that uses texts and a global issue different from those of your assessed oral (the Language A guides do not let your teacher rehearse the actual oral with you)</li>
