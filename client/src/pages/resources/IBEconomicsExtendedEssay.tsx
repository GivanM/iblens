  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>A clear theoretical frame:</strong> you can say in one sentence which part of the syllabus does the analytical work, such as elasticity, market structure, externalities or intervention.</li>
      ...
      <p>
        ...
        adapted to your case, with axes labelled for your actual market and, where
        ...
        then evaluate which assumptions hold in your market, which do not, and how
      ...
      <p>
        Use as many as your argument needs, which is typically several, but every
        diagram must be adapted to your specific market and referred to in the analysis.
