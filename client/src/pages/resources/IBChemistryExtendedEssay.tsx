  ...
  return (
    ...
    >
      ...
      <p>
        ...
        conditions under which the experiment is conducted. It should be narrow
        enough to be answered in 4,000 words, but significant enough to justify
        investigation.
      </p>
      ...
      <ul>
        ...
        <li>How does pH (3, 5, 7, 9, 11) affect the rate of hydrolysis of aspirin in aqueous solution, measured by UV-Vis absorbance at 296 nm?</li>
