...
export default function PsychologyIA2027() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>Exams in May 2027 or later:</strong> you write the research proposal, marked out of 24 with the criteria below.</li>
      ...
      <p>
        IBLens is session-aware for Psychology: choose <em>Internal Assessment → Psychology</em> in the analyser and keep "Exam session" on <em>May 2027, new syllabus</em>, the default. Your proposal is graded out of 24 against the four criteria above, criterion by criterion, with a free preview before any payment. Switch the session to <em>May / Nov 2026, current syllabus</em> for the experimental report out of 22.
      </p>

      <p>
        <Link href="/essay/psychology-ia">Check your Psychology IA against the 2027 criteria →</Link>
      </p>
