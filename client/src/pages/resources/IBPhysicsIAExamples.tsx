  ...
  return (
    ...
    >
      ...
      <AnnotatedExcerpt
        ...
        why="A falling frequency is true of an inverse relationship and of many others, so the weaker conclusion claims more than anything it shows. The stronger one states what the analysis established, with its uncertainty and its limits, and compares it with the accepted scientific context: the ideal-string equation and an independent value of μ."
      />
        ...
        stronger={
          <>
            ...
            <ol>
              ...
              <li>The comparison value is only as good as the stated gauge and the assumed density of steel. μ depends on the diameter squared, so a string 1.4% thinner than its label would on its own explain the whole 2.8% difference. A micrometer reading to 0.01 mm cannot settle this, because ±0.005 mm on 0.254 mm is ±4% in μ. Weighing the string itself afterwards, with its ball end cut off and the remaining length of about 1 m measured (about 0.4 g), on a 0.001 g balance would give μ directly to better than 0.5%, which would turn the comparison into a real test.</li>
            </ol>
          </>
        }
        why="The weaker evaluation names problems that could belong to any experiment and suggests improvements that would not change the result. The stronger one identifies weaknesses of this method, estimates how far each could move the final value compared with the 2.8% difference it is trying to explain, and pairs each with a realistic improvement that addresses it. That is what the top band of Evaluation describes: the relative impact of specific methodological weaknesses, with realistic improvements relevant to them."
      />
