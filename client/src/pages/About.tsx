...
export default function About() {
  return (
    ...
    >
      ...
      <p>
        IBLens gives IB students an honest, criterion-level read on their coursework before they submit it. Paste a draft, an Internal Assessment, an Extended Essay, a TOK essay or exhibition commentary, and get feedback structured around the same published assessment criteria your examiner will use, in about 90 seconds.
      </p>
      ...
      <ul>
        <li>
          <strong>The official criteria, per subject and session.</strong> The grading engine carries the assessment criteria for each supported component, criterion names, their mark allocations and a description of what each one assesses, including both Extended Essay rubrics (the current 34-mark criteria and the new 30-mark May 2027 criteria) and the 2027 formats for Psychology and Computer Science IAs. You pick the work type, subject and exam session; the engine applies the matching instrument.
        </li>
        <li>
      ...
      <p>
        Your first analysis is free, the predicted band range and your weakest criterion, no account needed. A full report costs $9.99 per essay. There is no subscription, and a <Link href="/refund-policy">7-day money-back guarantee</Link> applies.
      </p>
