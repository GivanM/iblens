  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <strong>AI analysis.</strong> The essay is analysed by a large language model (Anthropic's Claude) instructed with the relevant criteria. A full report gives a criterion-by-criterion assessment with a predicted band range, concrete comments and a word count against the limit.
        </li>
        <li>
