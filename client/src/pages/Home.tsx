...
/**
 * The home page (variant C). The photograph carries the first screen; the sample report is
 * made up and labelled so. The copy answers a visitor's doubts in order: what happens to the
 * draft and how far to trust it, whether it is allowed, what it covers and what it costs.
 */
          ...
          <div className="hc-wrap grid">
            <div className="steps">
              ...
              <div className="hc-step">
                ...
                <p>An AI marks the draft against the published IB criteria for that subject and session. The mark is an estimate: we have not measured it against examiner marks, so use it to decide what to fix. <Link href="/resources/sample-reports" className="hc-link">Read three real reports, unedited</Link></p>
              </div>
              <div className="hc-step">
