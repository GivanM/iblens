  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-card rounded-xl shadow-sm border border-border p-10 space-y-6">
          <div className="text-center">
            <span style={SERIF} className="text-2xl font-bold block mb-1">
              IB<span className="text-primary">Lens</span>
            </span>
            <h1 style={SERIF} className="text-xl font-bold mt-4">
              Sign in to IBLens
            </h1>
          </div>
