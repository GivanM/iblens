...
const FAQ = [
  ...
  },
  {
    ...
    a: "For the Extended Essay, ask your supervisor before you use it: the Extended Essay guide says students are not allowed to receive assistance with any aspect of the research, writing or proofreading of the essay beyond that which is permitted through their supervisor. For other work, check your teacher's and your school's policy first. IBLens returns feedback and never text you could hand in, and you must be able to explain whatever you change in your own words, which for the Extended Essay includes the viva voce.",
  },
  {
