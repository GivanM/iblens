...
const TIMELINE = [
  ...
  { date: "Mid-December", event: "November session results released (16 December in 2025: to schools from 9pm GMT and, by default, on candidates.ibo.org six hours later, at 3am GMT on 17 December, though your school can set any time from the same moment up to 48 hours later); your coordinator confirms the date" },
