...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricItems: [
      { title: "Criterion A: Integration of a key concept, 5 marks", text: "How well the analysis of the connection between your key concept and the organization runs through the whole project. The key concept has to be indicated on the title page, and describing the connection without analysing it stays in the lower marks." },
    ...
    mistakesHeading: "Mistakes the Business Management IA criteria penalize",
    mistakes: [
      ...
      { title: "A key concept on the title page only", text: "Naming the concept without analysing its connection to the organization. Criterion A rewards that analysis integrated throughout the project." },
    ...
    faq: [
      ...
      { q: "Can the project be about any business?", a: "It has to refer directly to one real organization, though it can consider industry-wide issues that affect that organization." },
