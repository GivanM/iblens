...
const config: SubjectConfig = {
  ...
  metaDescription:
    "AI feedback on your IB Mathematics: Applications and Interpretation IA exploration. Presentation, mathematical communication, personal engagement, reflection and use of mathematics, all scored against official IB criteria.",
  canonicalPath: "/essay/maths-ai-ia",
  heroHeadline: "Is your IB Math AI exploration on track for a top score?",
  heroSubline:
    "Paste your Mathematics: Applications and Interpretation IA and get criterion-by-criterion feedback in about 90 seconds, including Use of Mathematics and Reflection. Free first check.",
  criteria: [
