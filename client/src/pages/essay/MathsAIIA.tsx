...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    faq: [
      ...
      { q: "How does it know whether I take SL or HL?", a: "Write your course and level, for example Math AI SL, at the top of the text you paste. The grader asks for the subject only, and Use of mathematics has separate SL and HL descriptors." },
