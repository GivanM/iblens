...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricItems: [
      { title: "Criterion A: Presentation, 4 marks", text: "A coherent, well-organized and concise exploration with an introduction, a stated aim and a conclusion. Large data sets belong in an appendix, and the graphs and tables you discuss belong in the text." },
      ...
      { title: "Criterion E: Use of mathematics, 6 marks", text: "Relevant mathematics commensurate with the course, used correctly, with understanding demonstrated. At HL the top levels also need sophistication and rigour." },
    ],
    mistakesHeading: "Mistakes the Math AI IA criteria penalize",
    mistakes: [
    ...
    faq: [
      ...
      { q: "How does it know whether I take SL or HL?", a: "Write your course and level, for example Math AI SL, at the top of the text you paste. The analyzer asks for the subject only, and Use of mathematics has separate SL and HL descriptors." },
