...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricItems: [
      { title: "Research design, 6 marks", text: "A research question in a specific chemical context, with the choices behind the method explained: how the variables are measured, the range and repetition of trials, how other variables are controlled, and any safety, ethical or environmental issues the investigation raises. Someone else should be able to reproduce the method from your description." },
    ...
    mistakes: [
      ...
      { title: "Precision that changes from table to table", text: "Results quoted to more significant figures than the measurements support, or values given to a different number of decimal places from their uncertainties. Precise communication in Data analysis means following these conventions." },
    ...
    faq: [
      ...
      { q: "Does the word count include my data tables?", a: "No. The official 3,000-word count leaves out charts, diagrams, data tables, equations, formulas and calculations, citations, the bibliography and headers. IBLens counts every word you paste, so when you are close to the limit or over it, the report reminds you what the official count leaves out." },
