...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    faq: [
      { q: "Should I paste all three commentaries at once?", a: "Yes. The exhibition is marked as a whole, so choose your prompt in its own box and paste the commentaries on all three objects together, with each object labelled." },
