...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    mistakesHeading: "Mistakes the Physics IA criteria penalize",
    mistakes: [
      { title: "A curve where a straight line would say more", text: "Plotting a non-linear relationship as measured and reading nothing from it. When theory predicts the form of the relationship, linearizing the graph, for example plotting T² against L for a pendulum, lets you use the gradient and intercept. The guide lists linearizing graphs, where appropriate, among the skills you are expected to use." },
    ...
    faq: [
      ...
      { q: "Can I use it for a Physics Extended Essay?", a: "Choose Extended Essay in the analyzer and pick Physics as the subject. The EE is marked on its own criteria, so the IA criteria would put it on the wrong scale." },
