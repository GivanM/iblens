...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricItems: [
      { title: "Research design, 6 marks", text: "A focused research question described within a specific context, with the physics that predicts the relationship, and the methodological choices explained: how each variable is measured, the range and interval of the independent variable, repeats, control variables, and any safety, ethical or environmental issues. The method should be described well enough to reproduce." },
