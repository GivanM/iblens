...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    faq: [
      ...
      { q: "Can I use it for a Physics Extended Essay?", a: "Choose Extended Essay in the analyser and pick Physics as the subject. The EE is marked on its own criteria, so the IA criteria would put it on the wrong scale." },
