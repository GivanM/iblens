...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricIntro: [
      "The task depends on your exam session. From May 2027 the IA is a research proposal marked out of 24: you design a study but do not carry it out. Through November 2026 it is an experimental report marked out of 22. Choose your session in the analyzer and the report uses the matching criteria.",
    ...
    rubricNote: [
      "Through November 2026, the experimental report of 1,800 to 2,200 words is marked on Introduction (6 marks), Exploration (4), Analysis (6) and Evaluation (6), and is worth 25% of the final grade at SL and 20% at HL. Its top bands ask for an explained aim, the theory or model linked to your study and operationalized variables in the hypotheses; an explained design, sampling technique, choice of participants, controls and materials; descriptive and inferential statistics applied accurately, with a graph that addresses the hypothesis; and findings discussed against the theory, with limitations explained and modifications linked to them.",
    ],
    mistakesHeading: "Mistakes the Psychology IA criteria penalize",
    mistakes: [
      ...
      { title: "Variables not operationalized (through November 2026)", text: "A hypothesis such as 'stress affects memory'. The top Introduction band needs the independent and dependent variables operationalized in the hypotheses." },
    ...
    faq: [
      ...
      { q: "Can I use it for a Psychology Extended Essay?", a: "Choose Extended Essay in the analyzer and pick Psychology as the subject. The EE is marked on its own criteria." },
