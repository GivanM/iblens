...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricNote: [
      "Through November 2026, the experimental report of 1,800 to 2,200 words is marked on Introduction (6 marks), Exploration (4), Analysis (6) and Evaluation (6), and is worth 25% of the final grade at SL and 20% at HL. Its top bands ask for an aim whose relevance is explained, the theory or model described and its link to your study explained and operationalised variables in the hypotheses; an explained design, sampling technique, choice of participants, controls and materials; descriptive and inferential statistics applied accurately, with a graph that addresses the hypothesis; and findings discussed against the theory, with limitations explained and modifications linked to them.",
    ],
