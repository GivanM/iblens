...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    faq: [
      ...
      { q: "Does it count my words?", a: "Yes. It counts the words in what you paste and tells you when a commentary is close to 800 or over it, with what the official count leaves out, such as diagram labels, tables and references." },
