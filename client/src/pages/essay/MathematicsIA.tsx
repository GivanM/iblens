...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricItems: [
      { title: "Criterion A: Presentation, 4 marks", text: "A coherent, well-organised and concise exploration: an introduction, a stated aim and a conclusion, the graphs and tables you discuss placed in the text rather than in an appendix, and no repetitive calculations that add nothing." },
    ...
    faq: [
      ...
      { q: "Is it free?", a: "The first preview is free and needs no account: a range of totals that contains the estimate, usually your weakest criterion with its feedback, and the top risks in the draft. The full report, with every criterion marked and a ranked list of fixes, is $9.99, or $24.99 for five and $44.99 for ten." },
  ...
  relatedResources: [
    ...
    { label: "Math AA IA grader", href: "/essay/maths-aa-ia" },
