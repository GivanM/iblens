...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    rubricIntro: [
      ...
      "Because the oral is spoken, IBLens reads your outline or a transcript of a practice oral that uses texts and a global issue different from those of your assessed oral. A transcript gives the fullest report. An outline gives much less to go on, especially for Language.",
    ],
    rubricItems: [
