...
const config: SubjectConfig = {
  ...
  guide: {
    ...
    faq: [
      ...
      { q: "Literature or Language and Literature?", a: "Choose your course in the grader. The four criteria and their marks are the same in both courses, and the descriptors differ only where Language and Literature says works/texts instead of works. What differs is the task: in Literature the oral uses two works, one studied in translation, and in Language and Literature one literary work and one non-literary text." },
