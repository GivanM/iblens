...
const config: SubjectConfig = {
  ...
  heroSubline:
    "Paste a transcript of a practice run or your outline for the English A Individual Oral. A transcript is marked on all four criteria, an outline on the first three. Free preview, no account required.",
  ...
  guide: {
    ...
    faq: [
      ...
      { q: "Is it free?", a: "The first preview is free and needs no account: your band range, your weakest criterion with its full feedback, and the top risks in the draft. The full report, with a mark for every criterion from a transcript (from an outline, Criterion D is not marked) and a ranked list of fixes, is $9.99, or $24.99 for five and $44.99 for ten." },
