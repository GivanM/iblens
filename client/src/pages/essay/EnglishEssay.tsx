...
const config: SubjectConfig = {
  ...
  heroSubline:
    "Paste your outline for the English A individual oral, or a transcript of a practice oral on different works or a different global issue: the Language A guides do not allow a rehearsal of the actual oral. A transcript is marked on all four criteria, an outline on the first three. Free preview, no account required.",
  ...
  guide: {
    ...
    rubricIntro: [
      ...
      "Because the oral is spoken, IBLens reads your outline or a transcript of a practice oral that uses different works or a different global issue. A transcript gives the fullest report. An outline gives much less to go on, especially for Language.",
    ],
    rubricItems: [
    ...
    faq: [
      ...
      { q: "Is it free?", a: "The first preview is free and needs no account: your estimated range, your weakest criterion with its full feedback, and the top risks in the draft. The full report, with a mark for every criterion from a transcript (from an outline, Criterion D is not marked) and a ranked list of fixes, is $9.99, or $24.99 for five and $44.99 for ten." },
